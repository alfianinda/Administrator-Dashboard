                    ...
                    Dashboard <span class="badge">12</span>
                        ...
                        <div className="navbar" style={{backgroundColor: 'transparent', color: 'rgb(110, 7, 12)', border: '0.5px solid rgba(128, 128, 128, 0.253)'}}>
                            ...
                            <table className="table table-striped table-hover">
                                ...
                                <tr>
                                    <td><a href="./Invoice" className="cl-apaaja">Ganis Ezra Saputra</a></td>
                                    <td><a href="./Invoice" className="cl-apaaja">#100001</a></td>
                                    <td><a href="./Invoice" className="cl-apaaja">30 May 2018</a></td>
                                </tr>
                                <tr>
                                    <td><a href="./Invoice1" className="cl-apaaja">Laura</a></td>
                                    <td><a href="./Invoice1" className="cl-apaaja">#100002</a></td>
                                    <td><a href="./Invoice1" className="cl-apaaja">30 May 2018</a></td>
                                </tr>
                                <tr>
                                    <td><a href="./Invoice2" className="cl-apaaja">Emma Watson</a></td>
                                    <td><a href="./Invoice2" className="cl-apaaja">#100003</a></td>
                                    <td><a href="./Invoice2" className="cl-apaaja">30 May 2018</a></td>
                                </tr>
                                <tr>
                                    <td><a href="./Invoice3" className="cl-apaaja">Lily J. Collins</a></td>
                                    <td><a href="./Invoice3" className="cl-apaaja">#100004</a></td>
                                    <td><a href="./Invoice3" className="cl-apaaja">30 May 2018</a></td>
                                </tr>
                                </tbody></table>
                            </div>
                        </div>
