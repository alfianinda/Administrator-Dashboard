            ...
            Dashboard <span class="badge">12</span>
                ...
                <div className="navbar" style={{backgroundColor: 'transparent', color: 'rgb(110, 7, 12)', border: '0.5px solid rgba(128, 128, 128, 0.253)'}}>
                        ...
                        <li>
                            ...
                            <div className="input-group">
                                ...
                                <select className="form-control" style={{borderRadius: 0, borderColor: 'transparent'}}>
                                    ...
                                    <option> by Customer Number </option>
                                </select>
                                </div>
                    ...
                    <table className="table table-striped table-hover text-center">
                        ...
                        <tr>
                            <td><a href="./Profile" className="cl-apaaja">Ganis Ezra Saputra</a></td>
                            <td><a href="./Profile" className="cl-apaaja">CP100001</a></td>
                        </tr>
                        <tr>
                            <td><a href="./Profile1" className="cl-apaaja">Laura</a></td>
                            <td><a href="./Profile1" className="cl-apaaja">CP100002</a></td>
                        </tr>
                        <tr>
                            <td><a href="./Profile2" className="cl-apaaja">Emma Watson</a></td>
                            <td><a href="./Profile2" className="cl-apaaja">CP100003</a></td>
                        </tr>
                        <tr>
                            <td><a href="./Profile3" className="cl-apaaja">Lily J. Collins</a></td>
                            <td><a href="./Profile3" className="cl-apaaja">CP100004</a></td>
                        </tr>
                        </tbody></table>
                    </div>
                </div>
